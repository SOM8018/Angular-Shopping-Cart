 ...
 */
import { ExistsCallback, ServiceObject, Metadata, DeleteCallback, InstanceResponseCallback, GetConfig, GetMetadataCallback, DecorateRequestOptions, BodyResponseCallback } from '@google-cloud/common';
 ...
 * @property {object} 1 The full API response.
 */
export declare type GetBucketMetadataResponse = [object, request.Response];
/**
...
export interface GetBucketMetadataCallback extends GetMetadataCallback {
    (err: Error | null, metadata: Metadata | null, apiResponse: request.Response): void;
}
/**
...
declare class Bucket extends ServiceObject {
     ...
     * });
     */
    lock(metageneration: any, callback?: any): void;
    /**
     ...
     * });
     */
    removeRetentionPeriod(callback?: any): void;
    /**
     ...
     * });
     */
    setRetentionPeriod(duration: any, callback?: any): void;
    /**
